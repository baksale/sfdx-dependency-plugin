...
sfdx-dependency-plugin/1.0.3 win32-x64 node-v12.13.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [lib\commands\dependency\tree.js](https://github.com/baksale/sfdx-dependency-plugin/blob/v1.0.3/lib\commands\dependency\tree.js)_
<!-- commandsstop -->
