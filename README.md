...
sfdx-dependency-plugin/0.0.8 win32-x64 node-v12.13.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [lib\commands\sdlc\dependency\tree.js](https://github.com/baksale/sfdx-dependency-plugin/blob/v0.0.8/lib\commands\sdlc\dependency\tree.js)_
<!-- commandsstop -->
